    ...
    <html lang="en">
      <head>
        ...
        */}
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Red+Hat+Display:wght@300..500&family=DM+Mono:wght@400;500&family=Red+Hat+Text:wght@400;500;600&family=Jost:wght@300;400&display=swap"
        />
      </head>
      <body>
